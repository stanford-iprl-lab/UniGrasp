...
def get_model(point_cloud, is_training, num_class, bn_decay=None,gripper_feat=None,env_feat=None):
    ...
    l4_points = pointnet_fp_module(l4_xyz, l5_xyz, l4_points, l5_points, [512,256,256], is_training, bn_decay, scope='fa_layer0',bn=False)
    l3_points = pointnet_fp_module(l3_xyz, l4_xyz, l3_points, l4_points, [256,128,128], is_training, bn_decay, scope='fa_layer1',bn=False)
    l2_points = pointnet_fp_module(l2_xyz, l3_xyz, l2_points, l3_points, [128,128,128], is_training, bn_decay, scope='fa_layer2',bn=False)
    l1_points = pointnet_fp_module(l1_xyz, l2_xyz, l1_points, l2_points, [128,128,128], is_training, bn_decay, scope='fa_layer3',bn=False)
    l0_points = pointnet_fp_module(l0_xyz, l1_xyz, l0_points, l1_points, [128,128,64], is_training, bn_decay, scope='fa_layer4',bn=False)
    #print(l0_points)
    # FC layers
    net = tf_util.conv1d(l0_points, 64, 1, padding='VALID', bn=False, is_training=is_training, scope='fc1', bn_decay=bn_decay)
    end_points['feats'] = net 
    #net = tf_util.dropout(net, keep_prob=0.5, is_training=is_training, scope='dp1')
    net = tf_util.conv1d(net, num_class, 1, padding='VALID', bn=False, activation_fn=None, scope='fc2')
