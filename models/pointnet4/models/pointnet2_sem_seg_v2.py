...
def get_model(point_cloud, is_training, num_class, bn_decay=None,gripper_feat=None,env_feat=None):
    ...
    l4_xyz, l4_points, l4_indices = pointnet_sa_module(l3_xyz, l3_points, npoint=32, radius=0.08, nsample=32, mlp=[256,256,512], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer4')
    l5_xyz, l5_points, l5_indices = pointnet_sa_module(l4_xyz, l4_points, npoint=8, radius=0.24, nsample=16, mlp=[512,512,1024], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer5')
    ...
    extra_feat = tf.tile(extra_feat,[1,8,1])
    ...
    l3_points = pointnet_fp_module(l3_xyz, l4_xyz, l3_points, l4_points, [256,256,128], is_training, bn_decay, scope='fa_layer1')
    l2_points = pointnet_fp_module(l2_xyz, l3_xyz, l2_points, l3_points, [128,128,128], is_training, bn_decay, scope='fa_layer2')
    l1_points = pointnet_fp_module(l1_xyz, l2_xyz, l1_points, l2_points, [128,128,128], is_training, bn_decay, scope='fa_layer3')
    ...
    nor = tf_util.conv1d(l0_points,64, 1, padding='VALID', bn=True, is_training=is_training, scope='fc1', bn_decay=bn_decay)
    nor = tf_util.conv1d(nor, num_class, 1, padding='VALID', activation_fn=None, scope='fc2')
